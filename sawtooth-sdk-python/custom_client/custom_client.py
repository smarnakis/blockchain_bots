...
class IntkeyClient:
    """
    IntkeyClient: Client class responsible for packing commands intKey commands into transactions and batches 
    and send it to the validator using the REST API.
    """
